...
public class PowerEventSourceSingle extends RichSourceFunction<PowerEvent> {
	...
	public PowerEventSourceSingle() {
		this(MAX_RACK_ID, PAUSE, TEMPERATURE_RATIO, POWER_STD, POWER_MEAN, TEMP_STD, TEMP_MEAN);
	}

	public PowerEventSourceSingle(int maxRackId, long pause, double temperatureRatio, double powerStd, double powerMean,
